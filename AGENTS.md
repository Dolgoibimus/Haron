...
**Текущая версия:** 0.15.0 (Phase 1+3, Batch 15)
...
Batch 15 завершён. Читалка документов (DOC/DOCX/ODT/RTF), увеличенная зона тапа по иконке, синхронизация статус-бара с темой.
