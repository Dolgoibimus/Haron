...
**Текущая версия:** 0.13.0 (Phase 1+3, Batch 13)
**Текущая фаза:** Phase 1 — MVP (SAF UI), Phase 3 — инструменты
...
Batch 13 завершён. Свойства файла (EXIF + хеш + удаление EXIF), "Открыть в..." (внешнее приложение), анализатор памяти (круговая диаграмма + категории + крупные файлы + удаление).
