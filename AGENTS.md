...
Последние изменения: превью в иконках (все типы файлов), FB2 обложка/аннотация в читалке и превью,
кнопка "Отправить" → системный chooser, QuickPreviewDialog переведён на custom Dialog.
