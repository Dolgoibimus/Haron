...
| Батч | Задача | Статус |
|------|--------|--------|
| 30 | Поиск в архивах + OCR + USB OTG | ⚠️ не проверено |
| 31 | Счётчик на иконке + Сетевое обнаружение | ⚠️ не проверено |
| 32 | Встроенный терминал (простой) | ⚠️ не проверено |
...
| Батч | Задача | Статус |
|------|--------|--------|
| 35 | Открывалка по умолчанию | ⚠️ не проверено |
| 36 | Сравнение файлов и папок | ⚠️ не проверено |
| 37 | Полный терминал (VT100/ANSI) | ⚠️ не проверено |
