...
**Текущая версия:** 0.7.0 (Phase 1+3, Batch 7)
**Текущая фаза:** Phase 1 — MVP (основное), Phase 3 — UX-улучшения (частично)
...
Batch 7 завершён. Кликабельные breadcrumbs, история навигации ←→, тема (system/light/dark), "открыть в другой панели".
