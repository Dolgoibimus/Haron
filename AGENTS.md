...
Последние изменения: передача файлов — корпоративные сети, системная точка доступа, двухшаговый QR с блюром, отслеживание скачиваний.
...
- 13 действий на выбор
- Настройка в Настройках

### Голосовые команды
- 12 команд (русский + английский)
- Меню, полка, скрытые, создать, поиск, терминал, выделить все, обновить, домой, сортировка, настройки, передача
