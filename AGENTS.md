...
**Текущая версия:** 0.19.0 (Phase 1+3, Batch 19)
...
Batch 19 завершён. Система меток (File Tags): создание/редактирование/удаление меток с 8 цветами, назначение на файлы/папки, цветные точки в списке файлов, фильтр по метке в сортировке, миграция при переименовании, управление через drawer.
