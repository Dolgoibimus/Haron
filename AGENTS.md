...
**Текущая версия:** 0.14.1 (Phase 1+3, Batch 14.1)
...
Batch 14.1 завершён. Доработка детектора дубликатов: постоянные маркеры оригиналов, пометка папок-источников, превью файла, разделение зон тапа.
...
- Секция "Инструменты": корзина, анализатор памяти, детектор дубликатов
