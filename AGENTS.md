...
**Текущая версия:** 0.20.3 (Phase 1+3, Batch 20.3)
...
Batch 20.3 завершён. Защищённые файлы открываются во встроенных просмотрщиках (галерея, плеер, текстовый редактор, PDF, архивы). Создание папок/txt в защищённых директориях. Стрелка назад в панели работает при отсутствии истории навигации.
