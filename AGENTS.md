...
**Текущая версия:** 0.22.5 (Phase 2, Batch 22.5)
...
Batch 22.5 завершён. Полнотекстовый поиск, три режима индексации, ML Kit Image Labeling, поиск по содержимому в панели (Тт/FindInPage), FB2 reader.
