...
**Текущая версия:** 0.50 (Phase 4, Batch 50)
...
Batch 48 завершён — XLSX: открытие, пропорции колонок, per-cell borders, заголовки.
...
| 46 | Управление видимостью микрофона + режим просмотра/редактирования TXT | ⚠️ не проверено |
| 47 | Безрамочные таблицы DOCX/ODT + ODT column spans | ✅ проверено |
| 48 | XLSX: открытие, пропорции колонок, per-cell borders, заголовки | ⚠️ не проверено |
| 50 | Архивирование с паролем (AES-256), split ZIP, кросс-панельное сравнение | ⚠️ не проверено |
...
### Batch 50 — Архивирование с паролем и разбиением на части ⚠️ не проверено
