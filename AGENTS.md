...
**Текущая версия:** 0.20.4 (Phase 1+3, Batch 20.4)
...
Batch 20.4 завершён. Все фиксы Shield/AppLock: потоковое шифрование (без OOM), защита не блокирует обычные операции, кнопка Shield в панели (долгий тап — войти, тап — выйти), превью с «Открыть в...» для защищённых файлов.
