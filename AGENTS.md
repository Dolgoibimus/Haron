...
**Текущая версия:** 0.47 (Phase 4, Batch 47)
...
Batch 47 — Безрамочные таблицы DOCX/ODT + ODT column spans. Реализовано, ожидает проверки.
...
| 43 | Запоминание позиции чтения во всех читалках | ⚠️ не проверено |
...
| 47 | Безрамочные таблицы DOCX/ODT + ODT column spans | ⚠️ не проверено |
...
### Batch 43 — Запоминание позиции чтения + зума ⚠️ не проверено
...
### Batch 47 — Безрамочные таблицы DOCX/ODT + ODT column spans ⚠️ не проверено
