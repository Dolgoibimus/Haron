...
**Текущая версия:** 0.11.0 (Phase 1+3, Batch 11)
**Текущая фаза:** Phase 1 — MVP (SAF UI), Phase 3 — медиаплеер + текстовый редактор
...
Batch 11 завершён. Плейлист папки (авто-next + повтор), фоновое воспроизведение, экран блокировки, превью через PlaybackService (повтор папки + lock screen из превью), кнопка play/pause в шапке проводника.
