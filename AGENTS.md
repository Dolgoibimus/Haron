...
**Текущая версия:** 0.18.0 (Phase 1+3, Batch 18)
...
Batch 18 завершён. Пай-меню закладок переписано (6 плашек с именами папок, focusable=false). Новое правое пай-меню инструментов (6 инструментов). BackHandler закрывает поиск кнопкой «Назад».
