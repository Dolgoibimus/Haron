...
Batch 51b завершён — двухпанельный SMB-режим: SMB-файлы сверху + локальные файлы снизу, перетаскиваемый разделитель, кросс-панельные операции (скачивание/загрузка), навигация по хлебным крошкам исправлена.
