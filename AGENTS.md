...
Batch 23 завершён. Подсветка найденных слов в PDF ридере (Canvas overlay, жёлтый цвет), навигация между совпадениями (стрелки, счётчик, автоскролл). Fix: recycled bitmap crash.
