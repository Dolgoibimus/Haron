...
interface FileRepository {
    ...
    suspend fun copyFiles(sourcePaths: List<String>, destinationDir: String): Result<Int>
    suspend fun moveFiles(sourcePaths: List<String>, destinationDir: String): Result<Int>
